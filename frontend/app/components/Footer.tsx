        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Automatizamos procesos empresariales con IA y desarrollo personalizado.
            </p>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="bg-gray-800 hover:bg-cyan-500 p-2 rounded-lg transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a 
                  href="mailto:contacto@r2automate.com" 
                  className="hover:text-cyan-400 transition-colors break-words"
                >
                  contacto@r2automate.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
